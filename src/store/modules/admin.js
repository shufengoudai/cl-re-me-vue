...
const actions = {
        ...
        return new Promise((resolve, reject) => {
            userInfo()
                .then(response => {
                    ...
                    commit(types.RECEIVE_ADMIN_AUTHTYPE, data.authType);
    ...
    loginOut({ commit }) {
        return new Promise((resolve, reject) => {
            logout(getAdminId(),getToken())
                .then(() => {
                    commit(types.RECEIVE_ADMIN_ID, "");
                    commit(types.RECEIVE_ADMIN_TOKEN, "");
                    commit(types.RECEIVE_ADMIN_AUTHTYPE, "");
                    commit(types.RECEIVE_ADMIN_AUTH_RULES, []);
                    resolve();
                })
                .catch(error => {
...
const mutations = {
    ...
    [types.RECEIVE_ADMIN_AUTHTYPE](state, authType) {
