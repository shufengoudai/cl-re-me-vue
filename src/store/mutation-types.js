...
export const RECEIVE_ADMIN_AUTHTYPE = "RECEIVE_ADMIN_AUTHTYPE"; // 认证方式
...
// 白板相关
export const CREATE_TASK = "CREATE_TASK"; // 新建白板
export const UPDATE_TASK_STATUS = "UPDATE_TASK_STATUS"; // 白板更新
export const VIEW_TASK = "VIEW_TASK"; // 白板查看task

// kpt相关
export const UPDATE_KPT = "UPDATE_KPT"; // kpt更新
export const CANCEL_KPT = "CANCEL_KPT"; // kpt编辑取消
